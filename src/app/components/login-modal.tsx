...
export function LoginModal({ onClose, onSignup }: LoginModalProps) {
  ...
  const backgroundImage = "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&h=800&fit=crop"; // Image portuaire
      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            {/* Conteneur principal - MOBILE RÉDUIT */}
            <div className="flex flex-col md:flex-row h-full overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
              ...
              {/* Panneau de bienvenue - PRÉSENT SUR LES DEUX VERSIONS mais réduit sur mobile */}
              <motion.div
              ...
              >
                ...
                <div className="relative z-10 w-full">
                  ...
                  {/* Contenu bienvenue réduit sur mobile */}
                  <motion.div
                  ...
                  {/* Badge sécurité réduit sur mobile */}
                  <motion.div
              ...
              >
                {/* Titre ESPACE CLIENT - RÉDUIT SUR MOBILE */}
                <motion.div
                ...
                >
                  ...
                  {/* Champ Mot de passe - RÉDUIT SUR MOBILE */}
                  {!isResetMode && (
                    <motion.label
                      className="block"
                      initial={{ opacity: 0, y: 10 }}
                  ...
                  {/* Bouton principal - RÉDUIT SUR MOBILE */}
                  <motion.button
                    type="submit"
                  ...
                  {isResetMode && !isMobile && (
                    <motion.button
                      type="button"
                      className="w-full flex items-center justify-center gap-1.5 py-2 text-xs text-gray-600 hover:text-gray-900 transition-colors group"
                      onClick={switchToLogin}
                      whileHover={{ x: -3 }}
                    >
                ...
                {/* Section Google - RÉDUIT SUR MOBILE */}
                {!isResetMode && (
                  <>
                    <motion.div
                    ...
                    {/* Lien d'inscription - RÉDUIT SUR MOBILE */}
                    <motion.p
